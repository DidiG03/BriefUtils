        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="flex space-x-4">
              <a
                href="https://twitter.com/briefutils"
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/png-to-jpeg" className="text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400">
                  PNG to JPEG
                </Link>
              </li>
              <li>
                <Link href="/word-counter" className="text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400">
                  Word Counter
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/qr-generator" className="text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400">
                  QR Generator
                </Link>
              </li>
            </ul>
        ...
        <div className="mt-8 pt-8 border-t border-gray-200 dark:border-gray-700">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-500 dark:text-gray-400 text-sm">
              © {currentYear} BriefUtils. All rights reserved.
            </p>
